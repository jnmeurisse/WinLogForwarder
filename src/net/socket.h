...
namespace wlf::net {
	...
	*/
	...
	public:
		 ...
		 */
		virtual mbed_err connect(const Endpoint& ep, net_protocol protocol, const utl::Timer& timer);
		 ...
		 */
		virtual mbed_err bind(const Endpoint& ep, net_protocol protocol);
		...
		*/
		virtual mbed_err shutdown() noexcept;
		...
		*/
		mbed_err set_blocking_mode(bool enable) noexcept;
		 ...
		 */
		mbed_err set_nodelay(bool no_delay) noexcept;
		 ...
		 */
		virtual rcv_status recv_data(unsigned char* buf, size_t len) noexcept;
		 ...
		 */
		virtual snd_status send_data(const unsigned char* buf, size_t len) noexcept;
	...
	protected:
		...
		*/
		 ...
		 */
		virtual mbed_err accept(Socket& client_socket) noexcept;
